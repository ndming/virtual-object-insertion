...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="path to the target image, default to target.png in resource dir"
    )
    parser.add_argument(
        "-exr", action='store_true',
        help="use EXR resources to perform the insertion"
    )
    parser.add_argument(
        '--output', type=str, default="", 
        help="output file name, only PNG or EXR are allowed"
    )
    ...
    i_file = Path(os.path.abspath(target_file))
    i = load_file(i_file)
